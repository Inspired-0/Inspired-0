...
Анализировать встречи отдела продаж по критериям и находить инсайды, сервис получает и анализирует транскибации встреч, а далее хранит эту информацию и имеет агента для работы с ней
...
5. Модель анализирует встречу. Затем система проверяет ответ и сохраняет его в SQL.
...
Проверенные результаты попадают в рабочую таблицу и базу. Агент может отвечать на вопросы по уже обработанным данным.
