...
Автоматизация сложных простых и сложных действий в соц сетях, без использования апи.
...
Действия логируются и сохраняются, далее типовые действия преобразуются в скиллы и автоматически вызываются агентом.
...
Если модель не нужна, сценарий выполняется обычным кодом.
